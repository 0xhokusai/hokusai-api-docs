...
This tutorial will follow [this github repository](https://github.com/0xhokusai/hokusai-get-started).

To get started with Hokusai API fastly, please clone [the repository](https://github.com/0xhokusai/hokusai-get-started) and proceed with the following tutorial.
